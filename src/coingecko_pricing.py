...
def get_api_price(token_id, start_timestamp, end_timestamp):
    ...
    headers = {"accept": "application/json", "x-cg-pro-api-key": 'CG-aC3mQe9swJZcaWJpiEawPhU7'}
...
def get_price(block_number, token_address, imbalance):
    cleaned_token_list = load_cleaned_token_list('src/cleaned_coingecko_list.json')
